export default function PeakCardSkeleton() {
  return (
    <div style={card} aria-hidden="true">
      <div style={row}>
        <div style={{ flex: 1 }}>
          <div style={{ ...shimmer, height: 18, width: "70%", marginBottom: 10 }} />
      ...
      <div style={{ display: "flex", gap: 8, marginTop: 14 }}>
        <div style={{ ...shimmer, height: 26, width: 140, borderRadius: 999 }} />
        <div style={{ ...shimmer, height: 26, width: 160, borderRadius: 999 }} />
      </div>
    </div>
  );
}
